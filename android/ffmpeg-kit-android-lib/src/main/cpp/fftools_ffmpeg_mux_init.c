                          ...
                          const char *path, const char *fmt_spec)
{
    static const struct {
        ...
        { ENC_STATS_FRAME_NUM_IN,   "ni",       0, 0, true      },
        { ENC_STATS_TIMEBASE,       "tb"                        },
        { ENC_STATS_TIMEBASE_IN,    "tbi",      0, 0, true      },
        { ENC_STATS_PTS,            "pts"                       },
        { ENC_STATS_PTS_TIME,       "t"                         },
        { ENC_STATS_PTS_IN,         "ptsi",     0, 0, true      },
        { ENC_STATS_PTS_TIME_IN,    "ti",       0, 0, true      },
        { ENC_STATS_DTS,            "dts",      0, true         },
        { ENC_STATS_DTS_TIME,       "dt",       0, true         },
        { ENC_STATS_SAMPLE_NUM,     "sn",       true            },
        { ENC_STATS_NB_SAMPLES,     "samp",     true            },
        { ENC_STATS_PKT_SIZE,       "size",     0, true         },
        { ENC_STATS_BITRATE,        "br",       0, true         },
        { ENC_STATS_AVG_BITRATE,    "abr",      0, true         },
    };
